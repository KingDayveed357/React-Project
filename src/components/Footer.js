...
<button className="btn bg-[#65A2C3] text-white lowercase absolute p-4  top-0 right-0 rounded-full">Subscribe</button>
</div>
</ul>
</div>
</div>
...
<li class="mb-4">
<a href="/" class=" hover:text-[#A2CCE3] "><span className='text-[#A2CCE3]'>&#x003E;</span> Home</a>
</li>
<li class="mb-4">
<a href="/" class="hover:text-[#A2CCE3] "><span className='text-[#A2CCE3]'>&#x003E;</span> About us</a>
</li>
<li class="mb-4">
<a href="/" class="hover:text-[#A2CCE3] "><span className='text-[#A2CCE3]'>&#x003E;</span> Services</a>
</li>
<li class="mb-4">
<a href="/" class="hover:text-[#A2CCE3] "><span className='text-[#A2CCE3]'>&#x003E;</span> Terms of service</a>
</li>
<li class="mb-4">
<a href="/" class="hover:text-[#A2CCE3] "><span className='text-[#A2CCE3]'>&#x003E;</span> Privacy policy</a>
</li>
</ul>
</div>
<div>
